...
const Home = () => (
    <div className="main-page">
            ...
            <div className="container">
                ...
                <div className="programs-grid">
                    <div className="program-card">
                        ...
                        <p>
                            Лучшая программа, которую использовали я и мои ученики. Задания на
                            каждый день, полезные советы, теория, эффективные упражнения!
                        </p>
                        <img
        ...
        {/* Отзывы (укороченная версия, без модалки) */}
