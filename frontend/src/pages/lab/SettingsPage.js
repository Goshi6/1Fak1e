...
const SettingsPage = ({ user, onChange, onAccountLink, }) => {
    ...
    return (_jsxs("form", { className: "settings-form", onSubmit: (e) => e.preventDefault(), children: [_jsxs("label", { children: ["\u041D\u0438\u043A:", _jsx("input", { type: "text", value: user.name || "", disabled: !!user.faceitNickname, onChange: (e) => onChange({ name: e.target.value }) }), user.faceitNickname && (_jsx("span", { className: "info", children: "\u041D\u0438\u043A \u0431\u0435\u0440\u0451\u0442\u0441\u044F \u0441 Faceit (\u0430\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438)" }))] }), _jsxs("label", { children: ["\u0412\u043E\u0437\u0440\u0430\u0441\u0442:", _jsx("input", { type: "number", value: user.age || "", onChange: (e) => onChange({ age: Number(e.target.value) }) })] }), _jsxs("label", { children: ["\u041E \u0441\u0435\u0431\u0435:", _jsx("textarea", { value: user.about || "", onChange: (e) => onChange({ about: e.target.value }), maxLength: 280 })] }), _jsxs("label", { children: ["\u0410\u0432\u0430\u0442\u0430\u0440:", _jsx("input", { type: "file", accept: "image/*", onChange: (e) => {
