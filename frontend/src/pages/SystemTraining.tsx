    ...
    <div className="sistema-trenirovok">
                ...
                <div className="hero-text">
                    <div className="hero-main-line">
                        ...
                        <div className="hero-subtitle-container">
                            <p className="hero-subtitle">За 3 месяца улучши свою стрельбу, движения в игре</p>
                            <p className="hero-subtitle-second">Научись использовать все преимущества пика</p>
                        </div>
                        <p className="hero-description">Рекомендована игрокам от 1200 эло</p>
                    </div>
                    <div className="hero-buttons">
                        <button className="btn-primary" /* onClick={() => document.getElementById('order')?.scrollIntoView({ behavior: 'smooth', block: 'start' })} */>Заказать</button>
                        <button className="btn-secondary" /* onClick={() => window.location.href='/'} */>На главную</button>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div className="container">
                ...
                <div className="results-grid">
                    <div className="result-card">
                        <h3>Поймешь, что индивидуальные тренировки могут действительно давать прогнозируемый результат</h3>
                    ...
                    <div className="result-card">
                        <h3>Разовьешь необходимые для Counter-Strike элементы аиминга</h3>
                ...
                <div className="aim-content">
                    <div className="aim-columns">
                        <div className="aim-column">
                            <p>Ключевым навыком в аиминге для игрока в Counter-Strike является <strong>корректировка прицела</strong>*.</p>
                            <p>Поэтому нашей первоочередной задачей должна быть постановка уверенного уровня корректировки.</p>
                            <p>К сожалению, сама контра не предоставляет инструментов для развития этого навыка. И если корректировка не появилась сама собой, то у вас возникают проблемы с аимингом. Появляется ощущение, что тренировки не помогают.</p>
                        </div>
                        <div className="aim-column">
                            <p>Чтобы тренировать целенаправленно тот или иной элемент аиминга, существует AimLabs (и прочие аим-тренинги). Среди обычного КС комьюнити они не пользуются спросом, поскольку:</p>
                            <ul>
                                <li className="orange-text">либо человек смог развить в себе все необходимые навыки аиминга в игре без помощи аим-тренинга;</li>
                                <li className="orange-text">либо человек не умеет его использовать.</li>
                            </ul>
                            <p>AimLabs играть много для нас не имеет смысла, ведь наша цель все-таки в КС играть научиться, а не освоить все элементы аиминга.</p>
                        </div>
                    </div>
                    <div className="aim-center">
                        <p>Так или иначе, огромное количество про-игроков используют/использовали AimLabs в своей тренировке...</p>
                        <p>Форма - это про то, насколько эффективно мы можем использовать те навыки, которые у нас уже есть. А тренировка - это про работу над теми навыками, которые мы хотим в себе развить. Это принципиальная разница. <strong>Моя система</strong> - это <strong>про тренировку</strong>, а не про игровую форму.</p>
                        <p className="footnote">*Корректировка прицела - это быстрое микродвижение мышкой, выполяемое, чтобы исправить небольшую ошибку...</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div className="container">
                ...
                <div className="benefits-grid">
                    <div className="benefit-card">
                        ...
                        <p>Изучишь принципы построения эффективных индивидуальных тренировок...</p>
                    </div>
                    <div className="benefit-card">
        ...
        <section id="goals" className="goals">
            <div className="container">
                ...
                <p className="section-subtitle">Результаты работы по моей системе помогут тебе с любой целью!</p>
        ...
        <section id="program" className="program">
            <div className="container">
                <h2>Программа</h2>
                <p className="section-subtitle">3 месяца ты тренируешься по сформированной системе...</p>
                <div className="program-steps">
                    <div className="program-step">
                        <div className="step-number">1</div>
                        <div className="step-content">
                            <h3>AimLabs</h3>
                            <p>Нам нужно направить наше внимание на выработку хорошей корректировки прицела...</p>
                        </div>
                    </div>
                    <div className="program-step">
                    ...
                    <div className="program-step">
                        ...
                        <div className="step-content">
                            <h3>KZ</h3>
                            <p>Мувмент и умение хорошо нажимать кнопки на клавиатуре может влиять на игру не меньше...</p>
                        </div>
                    </div>
                    <div className="program-step">
                        ...
                        <div className="step-content">
                            <h3>Теория</h3>
                            <p>Вы получите доступ к теории, в которой я подробно расскажу про индивидуальные преимущества...</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="pricing" className="pricing">
            <div className="container">
                ...
                <div className="pricing-card">
                    ...
                    <button className="btn-primary btn-large" /* onClick={() => document.getElementById('order')?.scrollIntoView({ behavior: 'smooth', block: 'start' })} */>Заказать</button>
                </div>
            </div>
        </section>
        ...
        <section id="cases" className="testimonials">
            <div className="container">
                <h2>Мои кейсы</h2>
                <p className="testimonials-subtitle">Больше отзывов в разделе <a href="/keisy">Кейсы</a></p>
                <div className="testimonials-carousel">
                    <div className="testimonials-container">
                        <div className="testimonial-card" data-index="0">
                            <img src="/images/кейс 1.webp" alt="Кейс 1" className="testimonial-image" />
                        </div>
                        <div className="testimonial-card" data-index="1">
                            <img src="/images/кейс 2.webp" alt="Кейс 2" className="testimonial-image" />
                        </div>
                        <div className="testimonial-card" data-index="2">
                            <img src="/images/кейс 3.webp" alt="Кейс 3" className="testimonial-image" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="testimonialModal" className="testimonial-modal">
            <div className="modal-content">
                ...
                <img id="modalImage" src="" alt="Кейс" className="modal-image" />
            </div>
        </div>
            ...
            <div className="container">
                ...
                <div className="order-form">
                    <form id="orderForm" className="contact-form">
                        <input type="hidden" name="service" value="Система индивидуальных тренировок" />
